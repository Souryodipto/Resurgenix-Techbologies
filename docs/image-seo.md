...
| `/images/certifications/dpiit-startup-india-recognition.jpg` | **DPIIT Startup India Certificate of Recognition**<br>Official recognition credential under Startup India, Ministry of Commerce & Industry, Government of India. | 1024 × 708 px | JPEG | *"DPIIT Startup India Certificate of Recognition for Resurgenix Technologies Private Limited"* | **Lazy Loaded (Below Fold):** Rendered via `next/image` with explicit `width={1024}` and `height={708}` to guarantee zero CLS. Full resolution displayed inside accessible modal dialog. |
| `/images/certifications/bharatiya-vyapar-mahotsav-2026-participation.jpg` | **Bharatiya Vyapar Mahotsav 2026 Certificate of Participation**<br>Official exhibitor credential from Bharatiya Vyapar Mission (joint initiative with CAIT and ITPO). | 1024 × 724 px | JPEG | *"Certificate of Participation for Resurgenix Technologies Private Limited at Bharatiya Vyapar Mahotsav 2026"* | **Lazy Loaded (Below Fold):** Rendered via `next/image` with explicit `width={1024}` and `height={724}` to guarantee zero CLS. Full resolution displayed inside accessible modal dialog. |
